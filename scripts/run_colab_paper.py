...
MODEL_SPECS = {
    ...
    "amht_v4_stage2_round19_content_path": ModelSpec(
        ...
        config="train/config_amht_v4_stage2_round19_content_path.yaml",
        color="#166534",
        marker="h",
    ),
    ...
    "amht_v4_stage2_round17_state_memory_diag": ModelSpec(
        ...
        config="train/config_amht_v4_stage2_round17_state_memory_diag.yaml",
        color="#111827",
        marker="1",
    ),
    ...
    "amht_v4_stage2_round15": ModelSpec(
        ...
        config="train/config_amht_v4_stage2_round15.yaml",
        color="#0f172a",
        marker="D",
    ),
    ...
    "amht_v4_stage2_round13": ModelSpec(
        ...
        config="train/config_amht_v4_stage2_round13.yaml",
        color="#312e81",
        marker="D",
    ),
    "amht_v4_stage2_round12_retry": ModelSpec(
        key="amht_v4_stage2_round12_retry",
        label="AMHT-V4-Stage2-R12-Retry",
        config="train/config_amht_v4_stage2_round12_retry.yaml",
        color="#5b21b6",
        marker="P",
    ),
    ...
    "amht_v4_stage2_round10": ModelSpec(
        ...
        config="train/config_amht_v4_stage2_round10.yaml",
        color="#b91c1c",
        marker="X",
    ),
    ...
    "amht_v4_stage2_round8": ModelSpec(
        ...
        config="train/config_amht_v4_stage2_round8.yaml",
        color="#ea580c",
        marker=">",
    ),
    ...
    "transformer_v4_stage2_round10_baseline": ModelSpec(
        key="transformer_v4_stage2_round10_baseline",
        label="Transformer",
        config="train/config_transformer_v4_stage2_round10_baseline.yaml",
        color="#f67280",
        marker="s",
    ),
    ...
    "transformer_v4_stage2_round13_baseline": ModelSpec(
        key="transformer_v4_stage2_round13_baseline",
        label="Transformer",
        config="train/config_transformer_v4_stage2_round13_baseline.yaml",
        color="#f472b6",
        marker="s",
    ),
    ...
    "transformer_v4_stage2_round15_baseline": ModelSpec(
        key="transformer_v4_stage2_round15_baseline",
        label="Transformer",
        config="train/config_transformer_v4_stage2_round15_baseline.yaml",
        color="#db2777",
        marker="s",
    ),
    ...
    "transformer_v4_stage2_round17_state_memory_diag_baseline": ModelSpec(
        key="transformer_v4_stage2_round17_state_memory_diag_baseline",
        label="Transformer-StateMemory-Diag",
        config="train/config_transformer_v4_stage2_round17_state_memory_diag_baseline.yaml",
        color="#f9a8d4",
        marker="s",
    ),
    ...
    "mamba3_hybrid_v4_stage2_round10_baseline": ModelSpec(
        key="mamba3_hybrid_v4_stage2_round10_baseline",
        label="Mamba-3-Inspired Hybrid",
        config="train/config_mamba3_hybrid_v4_stage2_round10_baseline.yaml",
        color="#2a9d8f",
        marker="D",
    ),
    ...
    "mamba3_hybrid_v4_stage2_round13_baseline": ModelSpec(
        key="mamba3_hybrid_v4_stage2_round13_baseline",
        label="Mamba-3-Inspired Hybrid",
        config="train/config_mamba3_hybrid_v4_stage2_round13_baseline.yaml",
        color="#14b8a6",
        marker="D",
    ),
    ...
    "mamba3_hybrid_v4_stage2_round15_baseline": ModelSpec(
        key="mamba3_hybrid_v4_stage2_round15_baseline",
        label="Mamba-3-Inspired Hybrid",
        config="train/config_mamba3_hybrid_v4_stage2_round15_baseline.yaml",
        color="#115e59",
        marker="D",
    ),
    ...
    "mamba3_hybrid_v4_stage2_round17_state_memory_diag_baseline": ModelSpec(
        key="mamba3_hybrid_v4_stage2_round17_state_memory_diag_baseline",
        label="Mamba-3-Inspired Hybrid-StateMemory-Diag",
        config="train/config_mamba3_hybrid_v4_stage2_round17_state_memory_diag_baseline.yaml",
        color="#5eead4",
        marker="D",
    ),
...
PRESETS = {
    ...
    "stage2_round19_content_path_t4": {
        "models": [
            "amht_v4_stage2_round19_content_path",
            "transformer_v4_stage2_round18_content_retrieval_baseline",
            "mamba3_hybrid_v4_stage2_round18_content_retrieval_baseline",
    ...
    "stage2_round17_state_memory_diag_t4": {
        "models": [
            "amht_v4_stage2_round17_state_memory_diag",
            "transformer_v4_stage2_round17_state_memory_diag_baseline",
            "mamba3_hybrid_v4_stage2_round17_state_memory_diag_baseline",
    ...
    "stage2_round17_state_memory_diag_validate": {
        "models": [
            "amht_v4_stage2_round17_state_memory_diag",
            "transformer_v4_stage2_round17_state_memory_diag_baseline",
            "mamba3_hybrid_v4_stage2_round17_state_memory_diag_baseline",
    ...
    "stage2_round17_state_memory_diag": {
        "models": [
            "amht_v4_stage2_round17_state_memory_diag",
            "transformer_v4_stage2_round17_state_memory_diag_baseline",
            "mamba3_hybrid_v4_stage2_round17_state_memory_diag_baseline",

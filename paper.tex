...
For the current V2 draft, the reported baseline is the matched Transformer only. In the repository's updated V4 comparison plan, the additional hybrid comparator is named the \emph{Mamba-3-inspired hybrid baseline}. This wording is intentional: the implemented comparison model borrows stronger recurrent-backbone and fixed-period attention ideas for controlled benchmarking, but it is not presented as a strict reproduction of the original Mamba-3 paper.
...
\begin{tabular}{lccc}
\toprule
Model & Throughput (tokens/s) & Latency (ms/step) & Mean NIAH accuracy \\
\midrule
AMHT-Fast & $122862.4010 \pm 5773.6282$ & $66.7724 \pm 3.0694$ & $0.6190 \pm 0.0825$ \\
AMHT-Accurate & $121642.1870 \pm 2486.2791$ & $67.3639 \pm 1.3837$ & $1.0000 \pm 0.0000$ \\
Transformer & $96122.7907 \pm 4098.2288$ & $85.3266 \pm 3.5999$ & $0.5238 \pm 0.0825$ \\
\bottomrule
\end{tabular}
\caption{AMHT V2 frontier versus Transformer at 8K.}
\label{tab:main}
\end{table}

These results support the main empirical claim of this draft: the routed hybrid architecture exposes a useful efficiency-quality frontier while improving on the matched local-attention Transformer baseline in both throughput and retrieval quality at 8K. AMHT-Fast is the highest-throughput operating point, while AMHT-Accurate preserves a large throughput advantage and saturates the current retrieval benchmark.
...
\begin{tabular}{lccc}
\toprule
Depth & AMHT-Fast mean$\pm$std & AMHT-Accurate mean$\pm$std & Transformer mean$\pm$std \\
\midrule
0.05 & $0.6667 \pm 0.5774$ & $1.0000 \pm 0.0000$ & $0.6667 \pm 0.5774$ \\
0.15 & $0.3333 \pm 0.5774$ & $1.0000 \pm 0.0000$ & $0.3333 \pm 0.5774$ \\
0.30 & $0.6667 \pm 0.5774$ & $1.0000 \pm 0.0000$ & $0.6667 \pm 0.5774$ \\
0.50 & $1.0000 \pm 0.0000$ & $1.0000 \pm 0.0000$ & $0.3333 \pm 0.5774$ \\
0.70 & $0.3333 \pm 0.5774$ & $1.0000 \pm 0.0000$ & $0.3333 \pm 0.5774$ \\
0.85 & $0.6667 \pm 0.5774$ & $1.0000 \pm 0.0000$ & $0.6667 \pm 0.5774$ \\
0.95 & $0.6667 \pm 0.5774$ & $1.0000 \pm 0.0000$ & $0.6667 \pm 0.5774$ \\
\bottomrule
\end{tabular}
...
The strongest separation appears in the accurate operating point, which reaches perfect accuracy even at shallow and intermediate retrieval depths. This is precisely the regime where a model must maintain global information without paying universal attention cost.
...
\begin{tabular}{lccc}
\toprule
Sequence length & AMHT-Fast mean$\pm$std & AMHT-Accurate mean$\pm$std & Transformer mean$\pm$std \\
\midrule
1024 & $102373.8495 \pm 2612.6417$ & $94227.2293 \pm 9303.4593$ & $102736.7469 \pm 722.5284$ \\
2048 & $137688.3755 \pm 5603.9558$ & $124349.8471 \pm 19428.3921$ & $115244.4212 \pm 561.7383$ \\
4096 & $144233.1649 \pm 4243.4056$ & $130392.0129 \pm 7921.4776$ & $104229.2280 \pm 2769.8869$ \\
8192 & $141236.5166 \pm 5952.1760$ & $131166.3151 \pm 3597.4572$ & $103857.9270 \pm 1086.9657$ \\
\bottomrule
\end{tabular}
...
This is stronger than a single merged comparison because it shows that the same hybrid architecture can be tuned toward systems efficiency or retrieval quality depending on the target regime. The frontier is not rhetorical: both operating points remain faster than the Transformer baseline at 8K, while the accurate mode saturates the current retrieval benchmark.
...
Second, the baseline set is still incomplete. The current comparison includes a local-attention Transformer but not yet the repository's planned Mamba-3-inspired hybrid baseline or a pure recurrence-first baseline. Any future paper version should keep that wording precise: unless the implementation and training recipe are matched in detail, the comparison should be described as \emph{Mamba-3-inspired} rather than as a direct Mamba-3 reproduction.
...
\begin{itemize}
  \item explicit AMHT, Transformer, and future Mamba-3-inspired hybrid comparison configs,
